...
export default function ResultPosition ({ src, alt, width, left, text, description, tags }: TResultPositionProps) {
  return (
    <>
      ...
      {(description && tags) && <ResultPositionDetails description={description} tags={tags} />}
    </>
  )
}